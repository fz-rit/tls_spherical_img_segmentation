...
metrics_fig_path = root_dir / 'plot_output' / "feature_ablation_metrics.png"
iou_fig_path = root_dir / 'plot_output' / f"feature_ablation_per_class_iou_{cmap}.png"
...
fig_width = max(4, min(12, n_features * 0.4))  # adaptive width, min 6, max 12
fig_height = max(4, n_classes * 0.2)           # adaptive height based on classes
