...
copy_root_dir = Path('/home/fzhcis/mylab/data/point_cloud_segmentation/segmentation_on_unwrapped_image/palau_2024/mangrove3d')
...
image_cube_files = list(root_dir.glob('**/outputs/img/*_image_cube.npy'))
yaml_files = list(root_dir.glob('**/outputs/img/*_image_cube_meta.yaml'))
mask_files = list(root_dir.glob('**/outputs/img/*_segmk_refined.png'))
